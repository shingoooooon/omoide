  ...
  if (displayItems.length === 0) {
    return (
      <div className="text-center py-16">
        <div className="bg-white/80 backdrop-blur-sm rounded-2xl p-8 shadow-lg border-2 border-dashed border-blue-300 max-w-md mx-auto">
          <div className="mb-4 flex justify-center">
            <Icon name="photo" className="w-16 h-16 text-blue-500" />
          </div>
          <h3 className="text-xl font-bold text-blue-800 mb-2 font-handwriting">
            まだ写真がありません
          </h3>
          <p className="text-blue-700 font-handwriting">
  ...
  return (
    <div>
      ...
      <div className="max-w-6xl mx-auto">
        ...
        {/* Book Shadow */}
        <div className="absolute inset-0 bg-blue-900/20 rounded-2xl transform rotate-1 translate-x-2 translate-y-2"></div>
        
        {/* Book Cover */}
        <div className="relative bg-gradient-to-br from-blue-50 to-sky-100 rounded-2xl shadow-2xl border-4 border-blue-200 overflow-hidden">
          {/* Book Binding */}
          <div className="absolute left-0 top-0 bottom-0 w-8 bg-gradient-to-b from-blue-300 to-blue-500 border-r-2 border-blue-400">
            <div className="flex flex-col justify-center h-full space-y-4 px-1">
              {[...Array(5)].map((_, i) => (
                <div key={i} className="w-2 h-2 bg-blue-600 rounded-full mx-auto"></div>
              ))}
            </div>
          </div>
      ...
      <div className="flex justify-between items-center mt-8">
        <Button
          ...
          variant="outline"
          className="bg-blue-100 border-blue-300 text-blue-800 hover:bg-blue-200 disabled:opacity-50 font-handwriting"
        >
          ← 前のページ
        </Button>

        <div className="flex items-center space-x-2">
          <span className="text-blue-700 font-handwriting">
